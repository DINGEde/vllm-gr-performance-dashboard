...
def main():
    ...
    output_path = Path(r"D:\agentic_serving\AgentCacheKanban\runs\10014\2026-08-19\dashboard-summary.json")
    ...
    dashboard = {
        ...
        "run": {
            ...
            "description": "Main CI: 32 tasks, 16 max_concurrency, AgentCache progress-TTL controller (progress-TTL keys #79 removed)",
        },
        "environment": {
        ...
        "provenance": {
            "baseline_cc_result_dir": "results/main-ci-baseline-cc-32_16-20260819_090146",
            "candidate_cc_result_dir": "results/main-ci-candidate-cc-32_16-20260819_090146",
            "baseline_jiuwenswarm_result_dir": "results/main-ci-baseline-jiuwenswarm-32_16-20260819_090146",
            "candidate_jiuwenswarm_result_dir": "results/main-ci-candidate-jiuwenswarm-32_16-20260819_090146",
            "compare_cc_report": "benchkit-logs/main-ci-compare-cc-32_16-20260819_090146.txt",
            "compare_jiuwenswarm_report": "benchkit-logs/main-ci-compare-jiuwenswarm-32_16-20260819_090146.txt",
        },
