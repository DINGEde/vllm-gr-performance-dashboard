...
# Commit: 9aec995 (upstream/main, advanced from de56079; Trace Replay and benchmark tooling changes)
...
start_candidate() {
  ...
  # Keys removed by #79 are deliberately absent; remaining keys were validated at the current upstream HEAD.
