...
def main():
    ...
    output_path = Path(r"D:\agentic_serving\AgentCacheKanban\runs\10014\2026-08-25\dashboard-summary.json")
    ...
    dashboard = {
        ...
        "run": {
            ...
            "description": "Main CI: 32 tasks, 16 max_concurrency, AgentCache progress-TTL controller (#93 agentbench router-integration refactor; progress-TTL keys #79 removed)",
        },
        "environment": {
        ...
        "provenance": {
            "baseline_cc_result_dir": "results/main-ci-baseline-cc-32_16-20260824_212612",
            "candidate_cc_result_dir": "results/main-ci-candidate-cc-32_16-20260824_212612",
            "baseline_jiuwenswarm_result_dir": "results/main-ci-baseline-jiuwenswarm-32_16-20260824_212612",
            "candidate_jiuwenswarm_result_dir": "results/main-ci-candidate-jiuwenswarm-32_16-20260824_212612",
            "compare_cc_report": "benchkit-logs/main-ci-compare-cc-32_16-20260824_212612.txt",
            "compare_jiuwenswarm_report": "benchkit-logs/main-ci-compare-jiuwenswarm-32_16-20260824_212612.txt",
            "note": "Kanban folder labeled 2026-08-25 (intended CI date). Host clock was Aug 24 21:26 CST at launch, so runtime artifact paths carry timestamp 20260824_212612.",
        },
