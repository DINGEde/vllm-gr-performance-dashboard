#!/usr/bin/env python3
"""Generate dashboard-summary.json for the 2026-08-27 AgentCache Kanban run."""
...
def main():
    ...
    dashboard = {
        ...
        "provenance": {
            "baseline_cc_result_dir": "results/main-ci-baseline-cc-32_16-20260826_223448",
            "candidate_cc_result_dir": "results/main-ci-candidate-cc-32_16-20260826_223448",
            "baseline_jiuwenswarm_result_dir": "results/main-ci-baseline-jiuwenswarm-32_16-20260826_223448",
            "candidate_jiuwenswarm_result_dir": "results/main-ci-candidate-jiuwenswarm-32_16-20260826_223448",
            "compare_cc_report": "benchkit-logs/main-ci-compare-cc-32_16-20260826_223448.txt",
            "compare_jiuwenswarm_report": "benchkit-logs/main-ci-compare-jiuwenswarm-32_16-20260826_223448.txt",
            "note": "Kanban folder is labeled 2026-08-27. Host launched at 2026-08-26 22:34 CST, so formal runtime artifact paths carry timestamp 20260826_223448. The incomplete 20260826_214646 baseline-only preflight artifact is intentionally excluded.",
        },
