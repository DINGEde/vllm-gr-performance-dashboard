...
<div class="vgr-dashboard" id="vgr-dashboard">
  ...
  <section class="vgr-section vgr-pipeline-section"><div class="vgr-section-head"><div><p class="vgr-kicker">CPU mechanism</p><h2>Decode CPU pipeline</h2></div><p>Selected-run Mean values; schematic flow, not a scale timeline.</p></div><div id="vgr-cpu-pipeline"></div></section>
